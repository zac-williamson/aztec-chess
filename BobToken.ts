...
private_balances: {
  ...
  public declare methods: {
    ...
    __consume_opponent_move_and_update_game_state: ((input_state: { game_ended: boolean, move_count: FieldLike, mpc_state: { round_number: (bigint | number), user_encrypt_secret_hashes: FieldLike[], user_mask_secret_hashes: FieldLike[], previous_output_states: { ciphertext: { data: FieldLike[] }, mask_commitments: { x: FieldLike, y: FieldLike, is_infinite: boolean }[], user_updated_mask_commitments: { x: FieldLike, y: FieldLike, is_infinite: boolean }[][] }[] } }, user_state: { encrypt_secret: FieldLike, mask_secret: FieldLike, visible_squares: FieldLike[], game_state: { id: FieldLike, player_id: FieldLike, has_moved: FieldLike }[] }, player_id: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    /** args_hash_err(user_state: struct) */
    args_hash_err: ((user_state: { encrypt_secret: FieldLike, mask_secret: FieldLike, visible_squares: FieldLike[], game_state: { id: FieldLike, player_id: FieldLike, has_moved: FieldLike }[] }) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    /** update_user_state_from_move(is_first_two_moves: boolean, _user_state: struct, move_data: struct, player_id: field) */
